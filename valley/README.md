...
| Folder | What |
|---|---|
| [`docs/`](docs/) | The guides — simple intro/FAQ, team brief, how-to-use guide, dev guide, pitch/business case, build plan, and research updates. |
...
- **Simple intro + FAQ:** [`docs/valley-introduction-faq.md`](docs/valley-introduction-faq.md)
