...
- **Originality (25%)** — OhmConnect/Renew Home exist (CA/TX) but require months-long *utility enrollment*; Ontario's Peak Perks needs a *specific smart thermostat*. Nobody ships a **BYO-hardware, no-enrollment, open-source, carbon-AND-cost** shifter for Ontario ULO. The 10× ULO spread is a uniquely Ontario hook.
