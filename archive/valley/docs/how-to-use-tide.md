...
*Set it up once, then forget it. This is the practical companion to [`tide-team-brief.md`](tide-team-brief.md) (which explains **why** Tide exists) and the spike's [`valley/spike/README.md`](../spike/README.md) (how to **run the code**). This page is how a household actually **uses** it.*
...
For whoever does the technical setup. Full detail in [`valley/spike/README.md`](../spike/README.md).
...
To see it without any hardware: `npm run sim` (a full 24-hour simulation) or open `valley/spike/web/index.html` (the WAIT / GO NOW screen).
