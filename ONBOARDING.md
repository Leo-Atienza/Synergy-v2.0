...
New here? The 5-minute version of the whole project is **[`docs/tide-team-brief.pdf`](docs/tide-team-brief.pdf)** (plain English, no tech background needed). Read that first; come back here when you want the full brain.
...
2. Read the brief: click into [`docs/tide-team-brief.pdf`](docs/tide-team-brief.pdf) (GitHub previews PDFs in-page).
...
| You want… | Open |
|---|---|
| The whole idea in 5 minutes (plain English) | [`docs/tide-team-brief.pdf`](docs/tide-team-brief.pdf) |
...
1. **[`docs/tide-team-brief.pdf`](docs/tide-team-brief.pdf)** — the project in plain English.
